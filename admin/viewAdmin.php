...
<html>
    ...
    //delete record
        ...
        <div >
            ...
            <div class="ml-4 mr-2">
                <div >
                        <h3 class="text text-info" style="text-align: center">Admin List</h3><br>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="deleteAdmin.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-danger btn-sm">Delete</a>
                                        </td>

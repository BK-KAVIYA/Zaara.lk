...
<html>
    ...
    <body>
       ...
       $pass=$_POST['pwd'];
          ...
          $sql="INSERT INTO customer(user_name,Telephone,email,address,password)VALUES('$pname','$tel','$email','$add','$pass')";
            ...
            <div class="row">
                <div class="col-md-8 col-lg-8 mb-5">
                    <form id="AddDoctorForm" class="needs-validation p-5"   method="POST" enctype="multipart/form-data" novalidate>
                        <h3 class="text text-primary" style="text-align: left">Add Customer</h3><br>
                        <div class="form-row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" name="address" id="validationCustom01" placeholder="Address" value="" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                        ...
                        <br>
                        <button class="btn btn-primary" type="submit" name="addCustomer">Save Details</button>
                    </form>                   
                </div>
